...
if __name__ == "__main__":
    input_csv = "int_mri_dataset_draft_v1_combined_clean.csv"
    int_filter_file = "int_mri_dataset_draft_v1_combined_clean_validity.csv"
    #input_csv = "int_mri_dataset_partially_unknown_combined1_clean.csv"
    #int_filter_file = "int_mri_dataset_partially_unknown_combined1_clean_validity2.csv"
    #input_csv = "mri_dataset_unknown_clean.csv"
    #int_filter_file = "int_mri_dataset_unknown_clean_validity1.csv"

    output_csv = "mri_dataset_draft_v1_combined_filt_clean.csv"
    # output_csv = "mri_dataset_partially_unknown_combined1_filt_clean.csv"
